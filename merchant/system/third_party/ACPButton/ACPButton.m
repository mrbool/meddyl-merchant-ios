...
//#define kLabelFont [UIFont fontWithName:@"HelveticaNeue" size:21]
#define kLabelFont [UIFont fontWithName:@"Avenir Next" size:24]
...
- (void) setStyleType:(ACPButtonType)style {
    ...
    switch (style) {
        ...
        case ACPButtonOK:
            ...
            break;
        case ACPButtonRed:
            _topColor = [UIColor colorWithRed:0.95 green:0.02 blue:0.02 alpha:1];
            _bottomColor=[UIColor colorWithRed:0.7 green:0.15 blue:0.15 alpha:1];
            _borderColor = [UIColor colorWithRed:0.250980 green:0.505882 blue:0.686275 alpha:1] ;
            _inneColor = nil;
            break;
        case ACPButtonBlue:
            _topColor = [UIColor colorWithRed:0.423529 green:0.713726 blue:0.971569 alpha:1];
            _bottomColor=[UIColor colorWithRed:0.211765 green:0.482353 blue:0.865686 alpha:1];
            _borderColor = [UIColor colorWithRed:0.250980 green:0.505882 blue:0.736275 alpha:1] ;
            
            _topColor =[UIColor colorWithRed:0.211765 green:0.482353 blue:0.865686 alpha:1];
            _bottomColor=[UIColor colorWithRed:0.423529 green:0.713726 blue:0.971569 alpha:1];
            _borderColor = [UIColor colorWithRed:1 green:1 blue:1 alpha:1];
            _inneColor = nil;
            break;
        case ACPButtonGreen:
            _topColor = [UIColor colorWithRed:0 green:0.627451 blue:0 alpha:1];
            _bottomColor=[UIColor colorWithRed:0.4 green:0.8 blue:0 alpha:1];
        ...
        case ACPButtonDarkGrey:
            ...
            _borderColor = [UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:1];
        ...
        case ACPButtonPurple:
            ...
            break;
        case ACPButtonWhite:
            _topColor = [UIColor colorWithRed:1 green:1 blue:1 alpha:1];
            _bottomColor=[UIColor colorWithRed:0.666 green:0.666 blue:0.666 alpha:1];
            _borderColor = [UIColor colorWithRed:0.78 green:0.78 blue:0.78 alpha:1];
            _inneColor = nil;
            break;
        case ACPButtonPink:
            _topColor = [UIColor colorWithRed:255.0/255.0 green:243.0/255.0 blue:249.0/255.0 alpha:1];
            _bottomColor= [UIColor colorWithRed:255.0/255.0 green:105.0/255.0 blue:180.0/255.0 alpha:1];
            _borderColor = [UIColor colorWithRed:0.78 green:0.78 blue:0.78 alpha:1];
            _inneColor = nil;
            break;
        case ACPButtonFacebookBlue:
            //_topColor =[UIColor colorWithRed:0.686274 green:0.741176 blue:0.831372 alpha:1];
            _topColor =[UIColor colorWithRed:0.427450 green:0.517647 blue:0.705882 alpha:1];
            _bottomColor=[UIColor colorWithRed:0.231372 green:0.349019 blue:0.596078 alpha:1];
            _borderColor = [UIColor colorWithRed:1 green:1 blue:1 alpha:1];
            _inneColor = nil;
            break;
